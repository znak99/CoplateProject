import os
from .email_settings_c import email_host_password, email_host_user
...
SECRET_KEY = 'ixrwsje7ma0002=gn$^w7dxy816282)gel$(e#_xq)vre%#r!='
...
ROOT_URLCONF = 'CoplateProject.urls'
...
WSGI_APPLICATION = 'CoplateProject.wsgi.application'
